...
torch.save(model.state_dict(), "C:/Users/Snow/Desktop/ashwini2/unet_model.pth")

loss_all_epochs = np.asarray(loss_all_epochs)
np.save("C:/Users/Snow/Desktop/ashwini2/unet_loss_all_epochs.npy", loss_all_epochs)
