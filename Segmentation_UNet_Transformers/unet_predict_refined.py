...
"""Get the path of dataset; put this folder on the Desktop just change the username (username can be found via pwd) """

all_files = os.listdir("C:/Users/Snow/Desktop/ashwini2/dataset/malignant/IMG_resized/")
all_files2 = os.listdir("C:/Users/Snow/Desktop/ashwini2/dataset/benign/IMG_resized/")

image_path = "C:/Users/Snow/Desktop/ashwini2/dataset/malignant/"
image_path2 = "C:/Users/Snow/Desktop/ashwini2/dataset/benign/"
...
model_path = "C:/Users/Snow/Desktop/ashwini2/unet_model.pth"
...
np.save("C:/Users/Snow/Desktop/ashwini2/unet_all_dice_coefficients_malignant.npy", all_dice_coefficients_malignant)
np.save("C:/Users/Snow/Desktop/ashwini2/unet_all_jaccard_scores_malignant.npy", all_jaccard_scores_malignant)
...
plt.tight_layout()
plt.savefig("C:/Users/Snow/Desktop/ashwini2/unet_malignant_graph.pdf")
plt.show()
...
#np.save("C:/Users/Snow/Desktop/ashwini2/unet_all_dice_coefficient_benign.npy", all_dice_coefficients_benign)
#np.save("C:/Users/Snow/Desktop/ashwini2/unet_all_jaccard_scores_benign.npy", all_jaccard_scores_benign)

all_dice_coefficients_benign = np.asarray(all_dice_coefficients_benign)
all_jaccard_scores_benign = np.asarray(all_jaccard_scores_benign)

np.save("C:/Users/Snow/Desktop/ashwini2/unet_all_dice_coefficients_benign.npy", all_dice_coefficients_benign)
np.save("C:/Users/Snow/Desktop/ashwini2/unet_all_jaccard_scores_benign.npy", all_jaccard_scores_benign)
...
print("SD(all_jaccard_scores_benign): \t", np.round(np.std(all_jaccard_scores_benign),2), "\n")
...
fig.text(0.04, 0.5, 'Y-axis', va='center', rotation='vertical')
plt.tight_layout()
plt.savefig("C:/Users/Snow/Desktop/ashwini2/unet_benign_graph.pdf")
plt.show()